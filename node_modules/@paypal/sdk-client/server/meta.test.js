...
(0, _vitest.test)("should prevent query string parameters and hashs on the web-sdk bridge url", () => {
  const sdkUrl = "https://www.paypal.com/web-sdk/v6/bridge?name=value#hashvalue";
  const {
    getSDKLoader
  } = (0, _.unpackSDKMeta)(Buffer.from(JSON.stringify({
    url: sdkUrl
